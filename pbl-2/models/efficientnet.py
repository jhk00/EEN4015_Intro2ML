...
import math
from tools.tool import conv_bn_act
from tools.tool import SameConv
from tools.tool import SE
from tools.tool import drop_connect
from tools.tool import swish
...
class EfficientNet(nn.Module):
    def __init__(self, width_multipler, depth_multipler, do_ratio, min_width=0, width_divisor=8,
        ...
        self.stage3 = nn.Sequential(
            ...
            nn.BatchNorm2d(renew_width(1280), momentum=bn_momentum),
            swish(),
